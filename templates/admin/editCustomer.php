<?php include "templates/include/header.php" ?>
				...
				<input type="hidden" class="form-control" name="id" id="id" value="<?php echo $results['Customer']->id ?>"/>
				</br>
				...
				<input type="hidden" class="form-control" name="cuscode" id="cuscode" value="<?php if($results['Customer']->cuscode == ""){echo randomstr(15);}else{echo $results['Customer']->cuscode;} ?>"/>
				</br>
				...
				<p><a href="admin.php?action=deleteCustomer&amp;CustomerId=<?php echo $results['Customer']->id ?>" onclick="return confirm('Delete This Customer?')"><?php echo convertlang("Main|Delete Customer|objname"); ?></a></p>
				<?php } ?>
