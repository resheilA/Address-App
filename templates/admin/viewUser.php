...
<?php include "templates/include/header.php" ?>
					...
					<br><br>
					  <h1><?php echo convertlang($results['pageTitle']); ?></h1>
					   <?php 
					   echo 
					   "<a href='admin.php?action=editUser&UserId=".$results["User"]->id."'><button class='btn-primary'>".convertlang("Main|Edit")."</button></a>
					   ";
					   ?>
					   
					     <?php 
					   echo 
					   "<a href='admin.php?action=deleteUser&UserId=".$results["User"]->id."'><button class='btn-danger'  onclick='return confirm(\"".convertlang("Main|Delete User|objname")." ?\")'>".convertlang("Main|Delete")."</button></a>
					   ";
					   ?>
			<hr>
			<table class="table">
      ...
      <p><a href="admin.php?action=listUser">Return to Homepage</a></p>
