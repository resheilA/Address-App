...
<?php include "templates/include/header.php" ?>
					...
					<br><br>
					  <h1><?php echo convertlang($results['pageTitle']); ?></h1>
					   <?php 
					   echo 
					   "<a href='admin.php?action=editCustomerstatus&CustomerstatusId=".$results["Customerstatus"]->id."'><button class='btn-primary'>".convertlang("Main|Edit")."</button></a>
					   ";
					   ?>
					   
					     <?php 
					   echo 
					   "<a href='admin.php?action=deleteCustomerstatus&CustomerstatusId=".$results["Customerstatus"]->id."'><button class='btn-danger'  onclick='return confirm(\"".convertlang("Main|Delete Customerstatus|objname")." ?\")'>".convertlang("Main|Delete")."</button></a>
					   ";
					   ?>
			<hr>
			<table class="table">
      ...
      <p><a href="admin.php?action=listCustomerstatus">Return to Homepage</a></p>
