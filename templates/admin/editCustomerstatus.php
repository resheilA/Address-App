<?php include "templates/include/header.php" ?>
				...
				<input type="hidden" class="form-control" name="id" id="id" value="<?php echo $results['Customerstatus']->id ?>"/>
					
				<input type="hidden" class="form-control" name="latitude" id="latitude" value="<?php echo $results['Customerstatus']->latitude ?>"/>
					
				<input type="hidden" class="form-control" name="longitude" id="longitude" value="<?php echo $results['Customerstatus']->longitude ?>"/>
				...
				<input type="hidden" class="text-control" id="visitpicture1" name="visitpicture1" placeholder="<?php echo convertlang('Customerstatus|visitpicture1'); ?>"  autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['Customerstatus']->visitpicture1 )?>" />
				...
				<input type="hidden" class="form-control" id="visitpicture2" name="visitpicture2" placeholder="<?php echo convertlang('Customerstatus|visitpicture2'); ?>"  autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['Customerstatus']->visitpicture2 )?>" />
				...
				<input type="hidden" class="form-control" id="visitpicture3" name="visitpicture3" placeholder="<?php echo convertlang('Customerstatus|visitpicture3'); ?>"  autofocus maxlength="255" value="<?php echo htmlspecialchars( $results['Customerstatus']->visitpicture3 )?>" />
				</br>
				...
				<input type="hidden" class="form-control" name="statuscompany" id="statuscompany" value="<?php echo $results['Customerstatus']->statuscompany ?>"/>
				...
				<p><a href="admin.php?action=deleteCustomerstatus&amp;CustomerstatusId=<?php echo $results['Customerstatus']->id ?>" onclick="return confirm('Delete This Customerstatus?')"><?php echo convertlang("Main|Delete Customerstatus|objname"); ?></a></p>
				<?php } ?>
