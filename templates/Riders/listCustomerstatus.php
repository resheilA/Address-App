<?php include "templates/include/Ridersheader.php" ?>
			...
			<h1><?php echo convertlang("Main|All Customerstatus|objname"); ?></h1>
					...
					<a href="Riders.php?action=newCustomerstatus">
	...
	<?php foreach ( $results['Customerstatus'] as $Customerstatus ) { 
			echo '
			<tr>
			    <td><img src="'.$Customerstatus->visitpicture1.'" height="100px"/></img></td><td><a href=\'Riders.php?action=viewCustomerstatus&amp;id='.$Customerstatus->id.'\'>'.$Customerstatus->code.'</a></td>  
			   <td><a href=\'Riders.php?action=editCustomerstatus&amp;CustomerstatusId='.$Customerstatus->id.'\'"><button class="btn-primary">'.convertlang("Main|Edit").'</button></a></td>
			   '; 
	...
	?>
		  ...
		  <p><a href="Riders.php?action=newCustomerstatus"><?php echo convertlang("Main|AddaNew Customerstatus|objname"); ?></a></p>
