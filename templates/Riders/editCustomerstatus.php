<?php include "templates/include/Ridersheader.php" ?>
				...
				<?php $results['Customerstatus']->statusrider = $_SESSION["ridercode"]; ?>	
				...
				<input type="hidden" id="customerstatusaddedon" class="form-control" name="customerstatusaddedon" value="<?php echo $results['Customerstatus']->customerstatusaddedon ?>"/>
				...
				<p><a href="Riders.php?action=deleteCustomerstatus&amp;CustomerstatusId=<?php echo $results['Customerstatus']->id ?>" onclick="return confirm('Delete This Customerstatus?')"></p>
				<?php } ?>
