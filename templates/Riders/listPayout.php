<?php include "templates/include/Ridersheader.php" ?>
	...
	<?php foreach ( $results['Payout'] as $Payout ) { 
			echo '
			<tr>
			    <td>'.Riders::getByRidercode( $Payout->payoutrider)->ridername.'</td><td><a href=\'Riders.php?action=viewPayout&amp;id='.$Payout->id.'\'>'.$Payout->payoutamt.'</a></td><td><a href=\'Riders.php?action=viewPayout&amp;id='.$Payout->id.'\'>'.$Payout->payoutaddedon.'</a></td><td>'.Paymentmode::getById( $Payout->payoutstatus)->paymentmodename.'</td>'; 
